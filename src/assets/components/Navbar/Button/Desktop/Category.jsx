...
const Category = () => {
    return (
        <button>
                        <div className="transform duration-300 ease-in-out p-2 space-x-2 flex items-center bg-transparent hover:bg-white-smoke rounded cursor-pointer ">
                            <div
